...
keycloak = oauth.register(
    ...
    client_id=os.getenv("KEYCLOAK_CLIENT_D_ID"), # Use a specific client ID for app D
    client_secret=os.getenv("KEYCLOAK_CLIENT_D_SECRET"), # Use a specific client secret for app D
...
@login_required()
def home():
    return f'Bonjour {session["user"]["name"]} ! Vous êtes connecté à l\'application D'
